...
# Settings
CONFIDENCE_THRESHOLD = 0.5 # lowered so SSD & RCNN detect people
...
def detect_with_model(frame, model_name):
    ...
    if model_name == "YOLOv8":
        ...
        for box, cls, score in zip(detections['boxes'], detections['labels'], detections['scores']):
            if score > CONFIDENCE_THRESHOLD and int(cls) == 1:  # class 1 = person
...
def real_time_detection(video_source='pedvid.mp4'):
